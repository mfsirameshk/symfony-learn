...
use Ramesh\MyPropelBundle\Model\CategoryQuery;
...
abstract class BaseCategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Ramesh\\MyPropelBundle\\Model\\Category', $modelAlias = null)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Ramesh\MyPropelBundle\Model\ProductQuery A secondary query class using the current class as primary query
     */
    public function useProductQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinProduct($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Product', '\Ramesh\MyPropelBundle\Model\ProductQuery');
    }
