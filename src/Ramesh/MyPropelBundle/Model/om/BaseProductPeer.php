...
namespace Ramesh\MyPropelBundle\Model\om;
...
use \PropelException;
use \PropelPDO;
use Ramesh\MyPropelBundle\Model\CategoryPeer;
use Ramesh\MyPropelBundle\Model\Product;
use Ramesh\MyPropelBundle\Model\ProductPeer;
use Ramesh\MyPropelBundle\Model\map\ProductTableMap;
...
abstract class BaseProductPeer
{
    ...
    const OM_CLASS = 'Ramesh\\MyPropelBundle\\Model\\Product';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Price', 'Description', 'CategoryId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'price', 'description', 'categoryId', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID, ProductPeer::NAME, ProductPeer::PRICE, ProductPeer::DESCRIPTION, ProductPeer::CATEGORY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'PRICE', 'DESCRIPTION', 'CATEGORY_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'price', 'description', 'category_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Price' => 2, 'Description' => 3, 'CategoryId' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'price' => 2, 'description' => 3, 'categoryId' => 4, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::ID => 0, ProductPeer::NAME => 1, ProductPeer::PRICE => 2, ProductPeer::DESCRIPTION => 3, ProductPeer::CATEGORY_ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'PRICE' => 2, 'DESCRIPTION' => 3, 'CATEGORY_ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'price' => 2, 'description' => 3, 'category_id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProductPeer::CATEGORY_ID, CategoryPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Product objects pre-filled with their Category objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Product) to $obj2 (Category)
