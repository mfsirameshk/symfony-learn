...
class ProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Ramesh.MyPropelBundle.Model.map.ProductTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Ramesh\\MyPropelBundle\\Model\\Product');
    ...
    {
        $this->addRelation('Category', 'Ramesh\\MyPropelBundle\\Model\\Category', RelationMap::MANY_TO_ONE, array('category_id' => 'id', ), null, null);
    } // buildRelations()
